...
- **All AI crawlers allowed.** A portfolio exists to be found, including through assistants, and the content is public in the repo anyway. Runner up: the managed `robots.txt` that refuses training.
